...
const extractReviewExpedia = async (
  ...
  console.log('Get datasetId expedia', object.extra['datasetId']);
  ...
  console.log(results?.length, 'num reviews expedia');
...
export default extractReviewExpedia;
