...
const extractReviewTripcom = async (
  ...
  console.log('Get datasetId trip.com', object.extra['datasetId']);
  ...
  console.log(results?.length, 'num reviews trip.com');
...
export default extractReviewTripcom;
