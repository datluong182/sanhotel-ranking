...
import { ApifyTraveloka, Objects } from '../object.entity';

const actorId = process.env.ACTOR_ID_APIFY_TRAVELOKA;
const api_token = process.env.API_TOKEN_APIFY;

const extractDataTraveloka = async (
  platform: PLATFORM,
...
export default extractDataTraveloka;
